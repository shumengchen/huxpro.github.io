...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/shumengchen/shumengchen.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`shumengchen.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Smc Blog             # 你的博客网站标题
SEOTitle: Smc Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: shumengchen     # 你的github账号
weibo_username: 书蒙尘      # 你的微博账号，底部链接会自动更新的。
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/shumengchen/shumengchen.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **SMC Blog”** 但是我想要在搜索的时候显示 **“书蒙尘的博客 | Smc Blog”** ，这个就需要SEO Title来定义了。
